...
public class CodigoCliente {
	...
	public static void main(String[] args) {
		...
		System.out.println(e.incorporarPaquete("Buenos Aires", 200, 3, false));
		System.out.println(e.incorporarPaquete("Buenos Aires", 400, 4, false));
		System.out.println(e.incorporarPaquete("Mar del Plata", 200, 3, false));
		System.out.println(e.incorporarPaquete("Rosario", 80, 2, false));
		System.out.println(e.incorporarPaquete("Rosario", 250, 2, false));
